...
\begin{itemize}
	...
	\item PostgreSQL-Datenbank \Anhang{app:PostgreSQL}
	\item Apache Airflow für automatisierte Python-Skripte \Anhang{app:Airflow}
	\item SFTP-Server für den Datentransfer, siehe \Anhang{app:DummyData}
\end{itemize}
